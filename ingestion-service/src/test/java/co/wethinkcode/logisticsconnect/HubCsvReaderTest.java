...
public class HubCsvReaderTest {
    ...
    @Test
    void shouldCleanEasternCapeProvinceFromCsv() {
        HubCsvReader reader = new HubCsvReader();
        ...
        for (Hub currentHub : hubs) {
            if ("H-509".equals(currentHub.getHubId())) {
                hub = currentHub;
                break;
            }
        }
    ...
    @Test
    void shouldHandleNaActiveStatusFromCsv() {
        HubCsvReader reader = new HubCsvReader();
        ...
        for (Hub currentHub : hubs) {
            if ("H-517".equals(currentHub.getHubId())) {
                hub = currentHub;
                break;
            }
        }
